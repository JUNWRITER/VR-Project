...
namespace Hands.Scripts
{
    ...
    public class SnapHandAnimation : MonoBehaviour
    {
        ...
        private void TriggerAction_performed(InputAction.CallbackContext obj) => handAnimator.SetFloat(TriggerAnimation, 0);

        private void TriggerAction_canceled(InputAction.CallbackContext obj) => handAnimator.SetFloat(TriggerAnimation, 1);
